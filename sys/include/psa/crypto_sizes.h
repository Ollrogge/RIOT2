...
#if (IS_ACTIVE(MODULE_PSA_ASYMMETRIC_ECC_P256R1) || \
     IS_ACTIVE(MODULE_PSA_CIPHERS_AES_256_CBC) || \
     IS_ACTIVE(MODULE_PSA_MAC_HMAC_SHA_256) || \
     IS_ACTIVE(MODULE_PSA_SE_ATECCX08A_ECC))
#define CONFIG_PSA_MAX_KEY_SIZE 32
#elif (IS_ACTIVE(MODULE_PSA_CIPHERS_AES_192_CBC) || \
       IS_ACTIVE(MODULE_PSA_ASYMMETRIC_ECC_P192R1))
#define CONFIG_PSA_MAX_KEY_SIZE 24
#elif (IS_ACTIVE(MODULE_PSA_CIPHERS_AES_128_CBC)) || \
      (IS_ACTIVE(MODULE_PSA_CIPHERS_AES_128_ECB))
...
#if (IS_ACTIVE(MODULE_PSA_KEY_SLOT_MGMT))
...
#if (IS_ACTIVE(MODULE_PSA_SE_MGMT))
